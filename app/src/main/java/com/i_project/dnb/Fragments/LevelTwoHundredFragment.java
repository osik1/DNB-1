 ...
 */
public class LevelTwoHundredFragment extends Fragment implements LoaderManager.LoaderCallbacks< List< DnbTimeTableListAdapter > >{

    private final int API_KEY = 2 ;
    private final String NEWS_URL = "https://script.google.com/macros/s/AKfycbxOLElujQcy1-ZUer1KgEvK16gkTLUqYftApjNCM_IRTL3HSuDk/exec?id=1CGiYlgoymg7xnOmYnUgk3XcN5cZYvwhUAYfuPSJ6ZVA&sheet=Sheet1";
    ...
    public LevelTwoHundredFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        tableTextView = dnbRoot.findViewById(R.id.text_view);
